...
function pre_install(){
	...
	if [ "$xzy" == "2" ];then
	    xzy="https://raw.githubusercontent.com/Admin-backups/GOST-B/master/gost_2.3_linux_amd64.tar.gz"
    else
	    xzy="http://code.taobao.org/svn/supppiggost/gost_2.3_linux_amd64.tar.gz"
	fi
